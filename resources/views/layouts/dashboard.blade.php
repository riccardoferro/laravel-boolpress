...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark flex-md-nowrap p-0">
        ...
        <ul class="navbar-nav px-3 ml-auto">
            <li class="nav-item">
                {{-- non capisco qui perche' se tolgo questo tag a commentandolo mi fa vedere l'index.blade.php??
                    quando invece penso che qui devo aggiungergli il path admin, e quindi diventa admin.index e non solo index
                --}}
...
​
            {{-- In questo yield content abbiamo il contenuto effettivo dei post quindi dove c'e' messo tutti i posts id, titolo, slug, azioni
                  e anche dove andremo ad effettuare gli edit, creat ecc..
            --}}
